<template>
    <div class="teacher">
        ...
        >
            ...
            <el-table-column prop="old_school" label="old_school"></el-table-column>
            ...
            <el-table-column prop="study_status" label="study_status"></el-table-column>
            ...
            <el-table-column prop="old_major" label="old_major"></el-table-column>
