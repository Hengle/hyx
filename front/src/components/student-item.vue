    ...
    <el-row :gutter="20">
      ...
      <el-card class="box-card">
        ...
        <el-button-group>
          ...
          <el-button v-if="!create" @click="update" type="primary" size="mini">保存</el-button>
          <el-button v-if="create" @click="post" type="primary" size="mini">提交</el-button>
        </el-button-group>
          ...
          <el-col :span="12">
            ...
            <el-form size="mini" label-width="150px">
              ...
              <el-form-item label="备注：">
                <el-input v-if="edit_item" v-model="item.remark"></el-input>
          ...
          <el-col :span="12">
            ...
            <el-form size="mini" label-width="150px">
              ...
              <el-form-item label="目标学校：">
                <el-input v-if="edit_item" v-model="item.target_school" ></el-input>
                <span v-else> {{item.target_school}}</span>
              </el-form-item>

              <h3>专业课报班级信息</h3>

              <el-form-item label="报班级别：">
                <el-select v-if="edit_item" v-model="item.pro.class_level">
                  <el-option v-for="item in basic.classLevelProfessional" :label="item.name"
                             :value="item.id"></el-option>
                </el-select>
                <span v-else> {{item.pro.class_level}}</span>
              </el-form-item>
